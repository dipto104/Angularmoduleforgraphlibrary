var app = angular.module("tester", ["demo"]);
    app.controller("mycontroller", function($scope,factoryA) {
        ...
        $scope.myfn=function(){
            ...
            factoryA.myrunner('myCanvas',input,config);
            factoryA.myrunner('myCanvas2',input2,config);
        }
